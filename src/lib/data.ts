...
export const movies: Movie[] = [
  ...
  ...Array.from({ length: 80 }, (_, i) => {
    ...
    return {
      id: `${id}`,
      title: `Filme ou Série ${id}`,
      description: `Descrição para o filme ou série ${id}. Este é um placeholder.`,
      genre: ['Ação', 'Comédia', 'Drama', 'Ficção', 'Terror'][id % 5],
      cast: [`Ator ${id}A`, `Ator ${id}B`, `Ator ${id}C`],
      posterUrl: `https://picsum.photos/seed/${id}/500/750`,
      rating: 7.0 + (id % 15) / 10,
      year: 2000 + (id % 25),
